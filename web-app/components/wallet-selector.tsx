  ...
  return connected ? (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button className="w-full bg-linear-to-r from-blue-500 to-purple-500 text-white hover:from-blue-600 hover:to-purple-600">
          {account?.ansName ||
    ...
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      <DialogTrigger asChild>
        <Button className="w-full bg-linear-to-r from-blue-500 to-purple-500 text-white hover:from-blue-600 hover:to-purple-600">Connect a Wallet</Button>
      </DialogTrigger>
